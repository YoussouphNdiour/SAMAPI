                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row mb-30">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                <label for="billing-country">{{ translate('country') }}</label>
                                                                <select name="billing_country" id="billing-country"
                                                                        class="form-control select_picker select2">
                                                                    @forelse($countries as $index => $country)
                                                                        <option value="{{ $country['name'] }}" {{ $loop->first ? 'selected' : '' }}>
                                                                            {{ $country['name'] }}
                                                                        </option>
                                                                    @empty
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="city" id="city"
                                                                       ...
                                                                       class="form-control" {{$shipping_addresses->count()==0?'required':'Dakar'}}>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                @else
                                                                    <input type="hidden" value="1000" class="form-control" id="zip"
                                                                           name="zip"
                                                            ...
                                                            <div class="row mb-30">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        @else
                                                                            <input type="hidden" value="1000" class="form-control"
